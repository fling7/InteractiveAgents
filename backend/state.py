    ...
    def _generate_arrow_draft(
        ...
        *,
        ...
        dev_prompt = (
            ...
            "\n\nRegelbasierter 2D-Schnitt der Szene nahe am Boden (für die Platzierung nutzen, Kugeln = Objekte):\n"
            "Die room_objects enthalten Objekt-Typ und ID (name = type/id), nutze dies für Kontext.\n"
            f"{slice_payload}"
            "\n\nMLDSI JSON:\n"
            f"{arrow_text}"
        )
